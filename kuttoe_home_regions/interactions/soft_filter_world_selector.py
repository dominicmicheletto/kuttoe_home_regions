...
class _SoftFilterWorldSelectorPickerMenuProxyInteraction(_HomeWorldPickerMenuProxyInteraction):
    @classmethod
    ...
    def _run_interaction_gen(self, timeline):
        super(SoftFilterWorldSelectorSuperInteraction, self)._run_interaction_gen(timeline)
...
class SoftFilterWorldSelectorSuperInteraction(PickerSuperInteraction, DisplayNotificationMixin, HomeWorldSortOrderMixin):
    ...
    def _make_potential_interaction(cls, row_data):
        inst = _SoftFilterWorldSelectorPickerMenuProxyInteraction.generate(cls, picker_row_data=row_data)
    ...
    def _row_tests(cls, resolver, home_world: HomeWorldIds):
        ...
        tests = TestList((has_worlds_test, soft_filter_enabled_test))
...
lock_instance_tunables(SoftFilterWorldSelectorSuperInteraction, interaction_type=InteractionType.SETTING_WORLD_PICKER)
